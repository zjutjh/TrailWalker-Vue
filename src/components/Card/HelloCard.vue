<template>
  <v-card color="#26c6da" max-width="25rem" dark style="margin-top:1rem;" rounded="xl" elevation="4">
    <v-card-title>
      <v-avatar>
        <v-img src="jhlogo.png"></v-img>
      </v-avatar>
      <span class="title font-weight-light" style="padding-left: 1rem">精弘网络</span>
    </v-card-title>
    <v-card-text class="font-weight-bold">
      天气渐凉，又到了每年精弘毅行的季节了，<br/>
      叶子一片片飞舞而下，<br/>
      某一处山脉又将迎来熙熙攘攘的毅行人潮。<br/>
      这是一场盛大的相遇，<br/>
      也是精弘毅行与人一年一度不约而至的相遇，<br/>
      是不可辜负的好时光。<br/>
    </v-card-text>
